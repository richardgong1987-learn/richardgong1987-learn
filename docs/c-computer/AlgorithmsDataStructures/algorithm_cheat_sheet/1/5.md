...
这也是为什么我在 [学习数据结构和算法的框架思维](https://labuladong.gitbook.io/algo/mu-lu-ye/xue-xi-shu-ju-jie-gou-he-suan-fa-de-gao-xiao-fang-fa) 中这么强调二叉树的原因。

**下面我们由浅入深，从二叉树的层序遍历聊到 Dijkstra 算法，给出 Dijkstra 算法的代码框架，顺手秒杀几道运用 Dijkstra 算法的题目**。

# 图的抽象

前文 [图论第一期：遍历基础](https://labuladong.gitbook.io/algo/mu-lu-ye-1/mu-lu-ye-2/tu) 说过「图」这种数据结构的基本实现，图中的节点一般就抽象成一个数字（索引），图的具体实现一般是「邻接矩阵」或者「邻接表」。

![img](https://gblobscdn.gitbook.com/assets%2F-MgaO_np8dKO0rzhRKXx%2Fsync%2Fd9cabcdaabfc00a3529d1097256f11dd20608089.jpg?alt=media)

比如上图这幅图用邻接表和邻接矩阵的存储方式如下：

![img](https://gblobscdn.gitbook.com/assets%2F-MgaO_np8dKO0rzhRKXx%2Fsync%2F7978b9555d0cc81eeeb800cec93a58578f4e71e8.jpeg?alt=media)

前文 [图论第二期：拓扑排序](https://labuladong.gitbook.io/algo/mu-lu-ye-1/mu-lu-ye-2/tuo-pu-pai-xu) 告诉你，我们用邻接表的场景更多，结合上图，一幅图可以用如下 Java 代码表示：
...
![img](https://gblobscdn.gitbook.com/assets%2F-MgaO_np8dKO0rzhRKXx%2Fsync%2F1f45adf975a50bef0433f806a0c16f693ca3f0ed.jpeg?alt=media)
...
如果对 BFS 算法不熟悉，可以看前文 [BFS 算法框架](https://labuladong.gitbook.io/algo/mu-lu-ye-3/mu-lu-ye-1/bfs-kuang-jia)，这里只是为了让你做个对比，所谓 BFS 算法，就是把算法问题抽象成一幅「无权图」，然后继续玩二叉树层级遍历那一套罢了。
...
![img](https://gblobscdn.gitbook.com/assets%2F-MgaO_np8dKO0rzhRKXx%2Fsync%2F5e2ee661d2cfa076dddfd9e64225f991614d6e32.jpeg?alt=media)
...
![img](https://gblobscdn.gitbook.com/assets%2F-MgaO_np8dKO0rzhRKXx%2Fsync%2F2495adfb0505d08a080f5fc1ddf106f1648299b8.jpeg?alt=media)
...
![img](https://gblobscdn.gitbook.com/assets%2F-MgaO_np8dKO0rzhRKXx%2Fsync%2F2f2f2b1b5f385c262ba0163a4217b15a5f0ac5e2.jpeg?alt=media)

你下一步想遍历那个节点？就当前的情况来看，你觉得哪条路径更有「潜力」成为最短路径中的一部分？

从目前的情况来看，显然橙色路径的可能性更大嘛，所以我们希望节点 `2` 排在队列靠前的位置，优先被拿出来向后遍历。

所以我们使用 `PriorityQueue` 作为队列，让 `distFromStart` 的值较小的节点排在前面，这就类似我们之前讲 [贪心算法](https://labuladong.gitbook.io/algo/mu-lu-ye-2/mu-lu-ye-3/tiao-yue-you-xi) 说到的贪心思路，可以很大程度上优化算法的效率。
...
![img](https://gblobscdn.gitbook.com/assets%2F-MgaO_np8dKO0rzhRKXx%2Fsync%2Fe55b32ccfa7310b164dd73d9836b0e1805056b15.jpg?alt=media)
...
![img](https://gblobscdn.gitbook.com/assets%2F-MgaO_np8dKO0rzhRKXx%2Fsync%2F8053191938f671c7a93c584ab2b1e91204971322.jpg?alt=media)
...
![img](https://gblobscdn.gitbook.com/assets%2F-MgaO_np8dKO0rzhRKXx%2Fsync%2Fa47f033206f92d986670834867a69b428ff6e461.jpg?alt=media)
...
首先关于有向图和无向图，前文 [图算法基础](https://labuladong.gitbook.io/algo/mu-lu-ye-1/mu-lu-ye-2/tu) 说过，无向图本质上可以认为是「双向图」，从而转化成有向图。
